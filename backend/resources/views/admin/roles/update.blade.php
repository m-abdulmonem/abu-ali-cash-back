...
@section("content")
    ...
    <div class="row">
        <div class="col-12">
            ...
            <form action="{{ route("roles.update",$role->id) }}" method="POST">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <a class="btn btn-success" href="{{ admin_url("roles/create") }}"><i class="fa fa-plus"></i> {{ trans("home.new") }}</a>
                        <div class="btn btn-danger btn-delete float-right"
                             data-url="{{ admin_url("role/$role->id/delete") }}"
            ...
            <div class="card">
                <div class="card-header">
                    <a class="btn btn-success" href="{{ admin_url("permissions/create") }}"><i class="fa fa-plus"></i> {{ trans("roles.new_permission") }}</a>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
