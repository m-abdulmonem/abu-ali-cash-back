...
@section("content")
    ...
    @endpush
    <form action="{{ admin_url("profile/edit") }}" method="POST" enctype="multipart/form-data">
        <div class="row">
            <div class="col-9">
                @csrf
                @method("PUT")
            ...
            <div class="col-3">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="col-md-6">
                            <div class="form-group">
                                <img src="{{ image(profile("picture"),true) }}" class="preview-img img" alt="" id="logo" {{ settings('picture') ? 'style=display:block' : null }} />
    ...
    <div class="col-9">
        <!-- /.row -->
        <div class="card">
            <form action="{{ admin_url("profile/password/edit") }}" method="post">
                @csrf
                @method("PUT")
                <div class="card-header">
                    <button type="submit" class="btn btn-primary"><i class="fa fa-save"></i> {{ trans("home.save") }}</button>
