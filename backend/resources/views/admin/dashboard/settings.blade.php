...
@section("content")
    ...
    <div class="row">
        <div class="col-12">
            ...
            @if(user_can("view site settings"))
                <div class="card">
                    <form action="{{ admin_url("settings/main-info") }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method("PUT")
                        <div class="card-header">
                            <h3 class="card-title">{{ trans('settings.Main_info') }}</h3>
                        ...
                        <div class="card-body">
                            <div class="d-flex">
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="site_name_ar">{{ trans("settings.Site_name_ar") }}</label>
                                        <input class="form-control" name="site_name_ar" value="{{ old('site_name_ar') ? old('site_name_ar') : settings('site_name_ar') }}"
                                               placeholder="{{ trans("settings.Site_name_ar") }}" id="site_name_ar">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="site_name_en">{{ trans("settings.Site_name_en") }}</label>
                                        <input class="form-control" name="site_name_en" value="{{ old('site_name_ar') ? old('site_name_en') : settings('site_name_en') }}"
                                               placeholder="{{ trans("settings.Site_name_en") }}" id="site_name_en">
                                    </div>
                                </div>
                            </div>
                            <!-- ./d-flex -->
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="email" value="{{ old('email') ? old('email') : settings('email') }}"
                                               placeholder="{{ trans("settings.Email") }}" id="email" type="email">
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="phone" value="{{ old('phone') ? old('phone') : settings('phone') }}"
                                               placeholder="{{ trans("settings.Phone") }}" id="phone" type="tel" minlength="11" >
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-group">
                                        <label for="paginate">{{ trans("settings.Paginate") }}</label>
                                        <input class="form-control" name="paginate" value="{{ old('paginate') ? old('paginate') : settings('paginate') }}"
                                               placeholder="{{ trans("settings.Paginate") }}" id="paginate" type="number">
                                    </div>
                                </div>
                            </div>
                            <!-- ./d-flex -->
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="keywords">اا{{ trans("settings.Keywords") }}</label>
                                    <input class="form-control" name="keywords" value="{{ old('keywords') ? old('keywords') : settings('keywords') }}"
                                           placeholder="{{ trans("settings.Keywords") }}" id="keywords" data-role="tagsinput">
                                </div>
                            </div>
                            <!-- ./col-12 -->
                            ...
                            <div class="col-md-12" style="display: flex; flex-wrap: wrap">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="btn btn-default btn-file">{{ trans("settings.Icon") }}
                                            <i class="fas fa-paperclip"></i>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="description">{{ trans("settings.Site_description") }}</label>
                                    <textarea class="form-control" name="description" placeholder="{{ trans("settings.Site_description") }}"
            ...
            @endif
            <div class="card">
                <form action="{{ admin_url("settings/mobile-apps") }}" method="post">
                    @csrf
                    @method("PUT")
                    <div class="card-header">
            ...
            <div class="card">
                <form action="{{ admin_url("settings/maintenance") }}" method="post">
                    @csrf
                    @method("PUT")
                    <div class="card-header">
            ...
            <div class="card">
                <form action="{{ admin_url("settings/social-media") }}" method="post">
                    @csrf
                    @method("PUT")
                    <div class="card-header">
